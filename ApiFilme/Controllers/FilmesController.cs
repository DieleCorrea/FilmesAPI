...
namespace ApiFilme.Controllers
{
    ...
    public class FilmesController : ControllerBase
    {
        ...
        public IActionResult AtualizaFilmePatch(int id, JsonPatchDocument<UpdateFilmeDto> patch)
        {
            ...
            /*No contexto do método Map do AutoMapper, <UpdateFilmeDto> especifica o tipo de objeto que será criado como resultado do mapeamento. Isso significa que o AutoMapper irá mapear o objeto filme para o tipo UpdateFilmeDto.*/
